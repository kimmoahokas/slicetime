...
// this file is an apdated version of devices/csma/csma-net-device.h

#ifndef CSMA_DUPLEX_NET_DEVICE_H
#define CSMA_DUPLEX_NET_DEVICE_H
...
class Queue;
class CsmaDuplexChannel;
class ErrorModel;

/**
 * \class CsmaDuplexNetDevice
 * \brief A Device for a Csma Duplex Network Link.
 *
 * The Csma duplex net device class is analogous to layer 1 and 2 of the
 ...
 *
 * The device is similar to CsmaNetDevice except that it uses CsmaDuplexChannel as channel
 */
class CsmaDuplexNetDevice : public NetDevice 
{
public:
  ...
  /**
   * Construct a CsmaDuplexNetDevice
   *
   * This is the default constructor for a CsmaDuplexNetDevice.
   */
  CsmaDuplexNetDevice ();

  /**
   * Destroy a CsmaDuplexNetDevice
   *
   * This is the destructor for a CsmaDuplexNetDevice.
   */
  virtual ~CsmaDuplexNetDevice ();
   ...
   *
   * The function Attach is used to add a CsmaDuplexNetDevice to a CsmaDuplexChannel.
   *
   * \see SetDataRate ()
   * \see SetInterframeGap ()
   * \param ch a pointer to the channel to which this object is being attached.
   */
  bool Attach (Ptr<CsmaDuplexChannel> ch);

  /**
   * Attach a queue to the CsmaDuplexNetDevice.
   *
   * The CsmaDuplexNetDevice "owns" a queue.  This queue may be set by higher
  ...
  /**
   * Attach a receive ErrorModel to the CsmaDuplexNetDevice.
   *
   * The CsmaDuplexNetDevice may optionally include an ErrorModel in
  ...
  /**
   * Receive a packet from a connected CsmaDuplexChannel.
   *
   * The CsmaDuplexNetDevice receives packets from its connected channel
   * and forwards them up the protocol stack.  This is the public method
   * used by the channel to indicate that the last bit of a packet has 
   * arrived at the device.
   *
   * \see CsmaDuplexChannel
   * \param p a reference to the received packet
   * \param sender the CsmaDuplexNetDevice that transmitted the packet in the first place
   */
  void Receive (Ptr<Packet> p, Ptr<CsmaDuplexNetDevice> sender);
   ...
   */
  //void SetAddresss (Mac48Address addr);
   ...
   * for at least one of the these?  Which one?  There are too many free variables.IsMulti
   *
   ...
   * \see SetFrameSize
   */
  void SetEncapsulationMode (CsmaDuplexNetDevice::EncapsulationMode mode);
   ...
   */
  CsmaDuplexNetDevice::EncapsulationMode  GetEncapsulationMode (void);
...
private:
   ...
   * operator for CsmaDuplexNetDevice objects.

   */
  CsmaDuplexNetDevice &operator = (const CsmaDuplexNetDevice &o);

  /**
   * Copy constructor is declared but not implemented.  This disables the
   * copy constructor for CsmaDuplexNetDevice objects.
   */
  CsmaDuplexNetDevice (const CsmaDuplexNetDevice &o);
   ...
   * the CsmaDuplexNetDevice to begin the process of sending a packet
   ...
   *
   * \see CsmaDuplexChannel::TransmitStart ()
   ...
   *
   * \see CsmaDuplexChannel::TransmitEnd ()
  ...
  /**
   * The CsmaDuplexChannel to which this CsmaDuplexNetDevice has been
   * attached.
   * \see class CsmaDuplexChannel
   */
  Ptr<CsmaDuplexChannel> m_channel;

  /**
   * The Queue which this CsmaDuplexNetDevice uses as a packet source.
   * Management of this Queue has been delegated to the CsmaDuplexNetDevice
...
#endif // CSMA_DUPLEX_NET_DEVICE_H
