...
void
WifiPhy::SetPromiscSniffRxCallback (PromiscSniffRxCallback cb)
{
  m_promiscSniffRx = cb;
}
...
{
  if (!m_promiscSniffRx.IsNull ())
    {
      m_promiscSniffRx (this, packet, channelFreqMhz, channelNumber, rate, isShortPreamble, signalDbm, noiseDbm);
    }
