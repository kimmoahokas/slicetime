...
public:
  ...
  typedef Callback<void, Ptr<const Packet>, const WifiMacHeader*> MacLowTxCallback;
  ...
  // missed-ack statistics
  double MissedAckStatsGetFER (void);
...
private:
  ...
  // missed-ack statistics
  void MissedAckStatsGotAck (void);
  void MissedAckStatsMissedAck (void);
  ...
  // missed-ack statistics
  boost::circular_buffer<int> m_missedAckStatsBuf;
