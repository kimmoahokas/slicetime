...
public:
  ...
  /**
   * \param the function to be invoked when one of the DCF classes begins with a packet transmission
   */
  virtual void SetDcfTxStartCallback (Dcf::TxStart callback) = 0;
  ...
  /**
   * Returns the used instance of MacLow
   */
  virtual Ptr<MacLow> GetMacLow (void) = 0;
