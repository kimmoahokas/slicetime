...
public:
  ...
  typedef Callback<bool, Ptr<WifiPhy>, Ptr<const Packet>, uint16_t, uint16_t, uint32_t, bool, double, double> PromiscSniffRxCallback;
  ...
  void SetPromiscSniffRxCallback (PromiscSniffRxCallback cb);
...
private:
  ...
  PromiscSniffRxCallback m_promiscSniffRx;
